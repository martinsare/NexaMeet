  ...
  return (
    <div className="flex items-center justify-between gap-4 py-4">
      <div className="flex items-start gap-3">
        <div className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-signal-500/10 text-signal-300"><Icon className="h-4 w-4" /></div>
        <div>
          <p className="text-sm font-medium text-void-100">{title}</p>
          {description && <p className="text-xs text-void-400">{description}</p>}
        </div>
      </div>
      {control}
    </div>
      ...
      <div className="mx-auto max-w-2xl space-y-6">
            ...
            {[
              ...
              <button
                ...
                className={cn(
                  ...
                  theme === opt.id ? "border-signal-400 bg-signal-500/10" : "border-surface-border hover:bg-white/5"
                )}
              >
                <opt.icon className="h-5 w-5 text-void-100" />
                <span className="text-xs text-void-200">{opt.label}</span>
              </button>
            ))}
          </div>
        </Card>
        ...
        <Card className="p-6">
          ...
          <div className="mt-4 space-y-4">
            <div>
              <label className="mb-1.5 flex items-center gap-1.5 text-sm text-void-300"><Camera className="h-3.5 w-3.5" /> Camera</label>
            ...
            <div>
              <label className="mb-1.5 flex items-center gap-1.5 text-sm text-void-300"><Mic className="h-3.5 w-3.5" /> Microphone</label>
            ...
            <div>
              <label className="mb-1.5 flex items-center gap-1.5 text-sm text-void-300"><Volume2 className="h-3.5 w-3.5" /> Speaker</label>
        ...
        <Card className="divide-y divide-surface-border p-6">
          <h3 className="pb-2 font-display font-semibold text-white">Preferences</h3>
