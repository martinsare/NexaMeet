  ...
  return (
    <div className="min-h-screen bg-void-900 overflow-x-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 text-center">
          <FadeIn>
            ...
            <h1 className="font-display text-5xl font-semibold tracking-tight text-white md:text-6xl">
              ...
              <span className="text-gradient">actually meet.</span>
            </h1>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-void-200">
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <FadeIn>
          <p className="mb-12 text-xs font-semibold uppercase tracking-widest text-void-500">
            Core capabilities
          </p>
        </FadeIn>
            ...
            <ul className="mt-6 space-y-3">
              {["Live bandwidth indicator, always visible", "Auto recovery after connection loss", "Low Data Mode for rural & mobile networks"].map((t) => (
                <li key={t} className="flex items-start gap-3 text-sm text-void-100">
                  <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-pulse-400/20 text-pulse-400">
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
          <FadeIn className="order-2 md:order-1">
            <Card className="p-6">
              <div className="flex items-center gap-2 text-sm font-medium text-void-200">
                <Sparkles className="h-4 w-4 text-signal-300" /> AI Assistant
              </div>
          ...
          <FadeIn delay={0.1} className="order-1 md:order-2">
            ...
            <ul className="mt-6 space-y-3">
              {["Live captions & transcription", "Decisions and action items auto-tagged", "Ask the AI anything about any past meeting"].map((t) => (
                <li key={t} className="flex items-start gap-3 text-sm text-void-100">
                  <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-signal-400/20 text-signal-300">
                    <Check className="h-3 w-3" />
                  </span>
                  {t}
                </li>
            ...
            {[
              ...
              <FadeIn key={s.step} delay={i * 0.1}>
                <div className="relative rounded-2xl border border-surface-border bg-surface-raised/40 p-7">
                  ...
                  <div className="mt-4 flex h-11 w-11 items-center justify-center rounded-xl bg-signal-500/15 text-signal-300">
