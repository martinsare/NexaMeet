...
export function AuthLayout({ children, tagline }: { children: ReactNode; tagline?: string }) {
  return (
    <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
      <div className="relative hidden flex-col justify-between overflow-hidden bg-void-950 p-12 lg:flex">
        ...
        <motion.blockquote
          ...
          className="relative z-10 max-w-md text-void-100"
        >
          <p className="font-display text-xl leading-snug">
            {tagline ?? "\u201cWe stopped noticing the meeting tool. That's the whole point.\u201d"}
          </p>
          <footer className="mt-3 text-sm text-void-400">Renée Okafor, COO at Fielder Logistics</footer>
        </motion.blockquote>
      </div>
